 ...
 */
export function DisplayNameRow({ listingId, name, tags, onSaved }: DisplayNameRowProps) {
      ...
      <td colSpan={8} className="px-4 py-2">
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-center gap-2 text-sm text-gray-700">
            <span className="w-20 shrink-0 font-medium text-gray-500">노출상품명</span>
            {isEditingName ? (
              <>
                <input
                  type="text"
          ...
          <div className="flex flex-wrap items-start gap-2 text-sm text-gray-700">
            <span className="w-20 shrink-0 pt-1 font-medium text-gray-500">태그</span>
            {isEditingTags ? (
              <>
